...
const savedTrips = [
  {
    ...
    status: 'Em breve',
    description:
      'Roteiro de 4 dias explorando lagoas, dunas e experiencias pelo litoral norte.',
    date: '12 - 16 Nov',
    image: coastImg,
  ...
  },
  {
    ...
    status: 'Rascunho',
    description:
      'Passeios pela Via Costeira, Forte dos Reis Magos e gastronomia perto do mar.',
    date: 'A definir',
    image: natalImg,
        ...
        <aside className="dashboard-menu" aria-label="Menu do painel">
          ...
          <div className="dashboard-menu__links">
            {menuItems.map(([icon, label]) => (
              <a
                className={label === 'Meus Roteiros' ? 'active' : ''}
                href="/"
                key={label}
              >
                <Icon name={icon} />
          ...
          <section className="content-section favorites-section">
            ...
            <div className="favorites-grid">
              {favoritePlaces.map((place) => (
                <article className={`favorite-card ${place.className}`} key={place.title}>
